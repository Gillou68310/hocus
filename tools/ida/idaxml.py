...
class XmlExporter(IdaXml):
    ...
    def export_return_type(self, addr, name):
        if name == None:
            return
        ...
        self.start_element(RETURN_TYPE)
        self.write_attribute(DATATYPE, dtype)
    ...
    def export_functions(self):
        ...
        for addr in functions:
            ...
            self.export_return_type(addr, demangled)
...
#https://github.com/NationalSecurityAgency/ghidra/pull/1493/files
#TODO: Fix multidimentional array data DATATYPE
#TODO: Fix type dword instead of pointer?
